"""
================================================================================
EKA — CHANAKYA persona QLoRA fine-tune  |  Kaggle T4 (single GPU)
================================================================================
...
-----------------------------
    ~540 train examples, effective batch 16, 3 epochs  =  ~100 optimizer steps
...
# SECTION 3 — CONFIG
# ==============================================================================
MODE = "chanakya"  # <-- the ONLY line that differs from train_founder_lora_kaggle.py
